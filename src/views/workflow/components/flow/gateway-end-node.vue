<template>
  <el-tooltip class="box-item" effect="dark" :content="props.data.data.label" placement="top">
    <div class="flow-node-end-gateway" @click="handleClickNode">
  ...
  <Handle id="b" class="node" type="target" :position="Position.Top" />
  <Handle id="c" class="node" type="source" :position="Position.Bottom" />
  <Handle id="a" class="node" type="target" :position="Position.Left" />
  <Handle id="d" class="node" type="target" :position="Position.Right" />
</template>
<script setup>
