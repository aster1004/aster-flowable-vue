 ...
 * @description: 布局组件配置
 */
const layoutComponentConfig = computed(() => {
  return {
    title: t('workflow.component.layoutComponent'),
    components: [
      {
        id: '',
        title: '分组标题',
  ...
  } as WorkComponent.ComponentConfigGroup;
});

/**
 * @description: 基础组件配置
 */
const baseComponentConfig = computed(() => {
  return {
    title: t('workflow.component.basicComponent'),
    components: [
      {
        id: '',
        title: '单行文本',
 ...
 * @description: 高级组件配置
 */
const advancedComponentConfig = computed(() => {
  return {
    title: t('workflow.component.advancedComponent'),
    components: [
      {
        id: '',
        title: '流水号',
 ...
 * @description: 组件配置导出
 */
const componentConfigExport = computed(() => {
  return [
    layoutComponentConfig.value,
    baseComponentConfig.value,
    advancedComponentConfig.value,
  ] as WorkComponent.ComponentConfigGroup[];
});

export { componentConfigExport };
