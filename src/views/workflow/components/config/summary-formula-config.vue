 ...
 * @FilePath: \aster-flowable-vue\src\views\workflow\components\config\summary-formula-config.vue
...
<template>
  <div v-if="_formItem">
    ...
    <el-form-item :label="t('workflow.component.formulaConfig')">
      <el-button style="width: 100%" size="small" :icon="Setting" @click="showFormula">
    ...
    <formula
      ref="formulaRef"
      title="设置公式"
      :placeholder="'请设置公式（注：汇总计算仅支持SUM、AVG、MAX、MIN函数）'"
