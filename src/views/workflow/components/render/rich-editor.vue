 ...
 * @Date: 2025-06-11 11:55:07
 * @FilePath: \aster-flowable-vue\src\views\workflow\components\render\rich-editor.vue
 * @Description: 富文本编辑器
...
<template>
  <div v-if="!_hidden">
    ...
    >
      ...
      <el-input v-if="mode === 'design'" :model-value="_value" type="textarea" :rows="3" readonly />
      <tinymce-editor
        ref="tinymceEditorRef"
        class="w-full"
        v-else-if="mode === 'form' && !_readonly"
    ...
    <div v-else class="print-cell" ref="printRef">
      ...
      <div class="print-cell-value" :style="{ height: printMaxHeight + 'px' }">
        <div ref="printValueRef" v-html="_value"></div>
      </div>
    </div>
  </div>
</template>
