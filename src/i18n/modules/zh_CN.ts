...
export default {
  ...
  workflow: {
    ...
    rule: {
      appName: '应用名称不能为空',
      appIcon: '图标不能为空',
      appIconColor: '图标颜色不能为空',
      appSort: '排序不能为空',
      appStatus: '状态不能为空',
    },
    component: {
      layoutComponent: '布局控件',
      basicComponent: '基础控件',
      advancedComponent: '高级控件',
      code: '控件编码',
      name: '控件名称',
      placeholder: '提示文字',
      required: '是否必填',
      ...
      defaultValue: '默认值',
      hidden: '隐藏条件',
      hiddenTip: '隐藏条件，满足条件时隐藏控件',
      hiddenBtn: '请设置隐藏条件',
      hiddenPlaceholder: '当表达式值解析为true时, 当前控件隐藏',
      numericalPrecision: '数值精度',
      precisionTip: '小数点后位数',
      areaLevel: '地区级别',
      associatedForm: '关联表单',
      dataScope: '数据范围限定',
      ...
      formulaConfig: '公式配置',
      formulaConfigTip: '设置公式',
      dateFormat: '日期格式',
      displayDuration: '展示时长',
      isMultiple: '是否多选',
      deptFilter: '仅以下部门可被选择',
      description: '描述说明',
      fontSize: '字体大小',
      fontWeight: '字体粗细',
      fontColor: '字体颜色',
    ...
    process: {
      ...
      parallelBranch: '并行分支',
      inclusiveBranch: '包含分支',
      subProcess: '子流程',
      processCompleted: '流程结束',
      nodeProperty: '节点属性',
      nodeId: '节点ID',
      nodeApprover: '审批人',
      approverEmpty: '审批人为空时',
      mutiApproverType: '多人审批时审批方式',
      formPermission: '表单权限',
      buttonPermission: '操作按钮',
      condition: '条件设置',
    ...
    settings: {
      submitValidate: '提交校验',
      dynamicValidate: '动态校验',
      businessRule: '业务规则',
      messageReminder: '消息提醒',
      associationList: '关联列表',
      printTemplate: '打印模板',
      addRule: '新增规则',
      immediatelySet: '立即设置',
      submitEmpty: '暂无提交校验',
      submitEmptyTip: '在提交表单时，满足校验规则的数据将不允许提交',
      submitDesc:
        '说明：在提交表单时满足以下校验规则的数据将不允许提交，多条规则之间请避免输入互斥条件，以免前台校验出错',
      businessEmpty: '暂无业务规则',
      businessEmptyTip: '设置业务规则能对其它表单的数据进行插入、更新、删除等操作',
      businessDesc:
        '说明：业务规则用于处理表单与表单之间的数据关联变更，通过业务规则能对其它表单的数据进行插入、更新、删除等操作',
      listEmpty: '当前表单暂未被其他表单所关联',
      listEmptyTip: '请在其他表单的关联控件关联该表单时，再进行设置',
      listDesc:
        '说明：当前表单有被其他表单中关联控件关联时，可在此处配置关联列表，实现对其他表单数据的快捷查看与新增',
      printAdd: '新增模板',
      printPreview: '默认模板预览',
      printEmpty: '您还没添加任何自定义打印模板',
      printEmptyTip: '可以对表单内的字段进行自由的排版用于日常单据的打印',
      printDesc: '说明：可以对表单内的字段进行自由的排版用于日常单据的打印',
      systemField: '系统字段',
      formField: '表单字段',
    },
    error: {
      submitAgain: '表单编码和流程实例id不能为空',
      formCode: '表单编码不能为空',
      formId: '表单id不能为空',
      params: '参数有问题!',
    },
